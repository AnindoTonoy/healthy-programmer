...
1. Water (3.5 litres water have to drink) - water.mp3 - play every 28 mins -for stop the music type -
Drank - then save this as log.

2. Eyes - eyes.mp3 - play every 35 mins - for stop the music type - Eyedone - then save this as log.

3.Physical activity - physical.mp3 - play every 45 mins - for stop the music type - Exdone - then save this as log.
